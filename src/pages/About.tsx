...
const team = [
  { name: "Cedric Belisario", role: "Fullstack Dev", image: cedric, color: "from-yellow-500/20" },
  { name: "Nathaniel Vasquez", role: "Fullstack Dev", image: nathaniel, color: "from-blue-500/20" },
  { name: "Charles Alvaran", role: "Front Developer/Web Designer", image: charles, color: "from-amber-500/20" },
  { name: "John Marco Paja", role: "Front Developer/Web Designer", image: john, color: "from-emerald-500/20" },
  { name: "Patrick Mirhan", role: "Project Manager/Front Developer/Web Designer", image: patrick, color: "from-amber-500/20" },
]
            ...
            {team.map((member, i) => (
              ...
              >
                ...
                <div className="absolute inset-0 p-10 flex flex-col justify-end">
                  ...
                  >
                    <p className="text-[10px] font-black tracking-[0.3em] text-yellow-400 uppercase mb-3 drop-shadow-lg">Team Member</p>
