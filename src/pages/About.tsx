...
const team = [
  { name: "Cedric Belisario", role: "Fullstack Dev", image: cedric, color: "from-purple-500/20" },
  { name: "Nathaniel Vasquez", role: "Fullstack Dev", image: nathaniel, color: "from-blue-500/20" },
  { name: "Charles Alvaran", role: "Front Developer/Web Designer", image: charles, color: "from-pink-500/20" },
            ...
            {team.map((member, i) => (
              ...
              >
                ...
                <div className="absolute inset-0 p-10 flex flex-col justify-end">
                  ...
                  >
                    <p className="text-[10px] font-black tracking-[0.3em] text-purple-400 uppercase mb-3 drop-shadow-lg">Team Member</p>
