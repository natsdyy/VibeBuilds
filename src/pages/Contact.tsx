...
const Contact: React.FC = () => {
  return (
    <div className="min-h-screen bg-[var(--background)] font-sans text-foreground selection:bg-yellow-500/30 overflow-x-hidden transition-colors duration-300">
      <GridBackground lineColor="rgba(234, 179, 8, 0.1)" spacing={60} />
      <Header />
      ...
      <main className="pt-40 pb-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            ...
            >
              <div className="absolute -inset-1 bg-gradient-to-r from-yellow-500 to-amber-500 rounded-[40px] blur-2xl opacity-0 group-hover:opacity-10 transition-opacity" />
              <form className="space-y-6 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input type="text" placeholder="John Doe" className="w-full px-6 py-4 rounded-2xl bg-foreground/5 border border-foreground/10 focus:border-yellow-500/50 focus:outline-none transition-all" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-[10px] font-black tracking-[0.2em] uppercase text-[var(--text-muted)] ml-2">Email Address</label>
                    <input type="email" placeholder="john@example.com" className="w-full px-6 py-4 rounded-2xl bg-foreground/5 border border-foreground/10 focus:border-yellow-500/50 focus:outline-none transition-all" />
                  </div>
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] font-black tracking-[0.2em] uppercase text-[var(--text-muted)] ml-2">Message</label>
                  <textarea rows={4} placeholder="Tell us about your vision..." className="w-full px-6 py-4 rounded-2xl bg-foreground/5 border border-foreground/10 focus:border-yellow-500/50 focus:outline-none transition-all resize-none"></textarea>
                </div>
